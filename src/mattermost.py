...
mmUrl = os.environ.get("MATTERMOST_SERVER_URL") or "http://localhost:8065/api/v4"
loginData = {
                "login_id": os.environ.get("MM_USER_NAME") or "Admin", 
                "password": os.environ.get("MM_PASSWORD") or "password"
            }
personal_access_token = os.environ.get("MM_PERSONAL_ACCESS_TOKEN") or None
...
def getAllPosts():
    authHeader = "Bearer " + get_auth_token()
    print('\n')
    print('-'*20)
    print('-'*20)
    print('\n')
